    ...
    [
      ...
      row.new('❇️ Rule'),
        panels.combo.stat.a_bigger_value_is_a_problem(
          '❌ Failed ❇️ Rule', queries.diff_over_time(queries.workflows.Rule.average_failed_per_minute)
        ),
        ...
        panels.combo.stat.a_bigger_value_is_better(
          '✴️ Events ❇️ Rule', queries.diff_over_time(queries.workflows.Rule.average_events_per_minute)
        ),
        panels.combo.timeSeries.current_vs_prev(
        ...
        panels.combo.stat.a_bigger_value_is_a_problem(
          '🕒 Duration of ❇️ Rule', queries.diff_over_time(queries.workflows.Rule.average_duration_per_minute)
        ),
        panels.combo.timeSeries.current_vs_prev(
        ...
        panels.combo.stat.a_bigger_value_is_a_problem(
          '🕒 Duration of ❇️ Rule', queries.diff_over_time(queries.workflows.Rule.average_duration_per_hour)
        ),
        panels.combo.timeSeries.current_vs_prev(
        ...
        panels.combo.stat.a_bigger_value_is_a_problem(
          '🕒 Average Duration of one ❇️ Rule', queries.diff_over_time(queries.workflows.Rule.average_duration_per_event)
        ),
        panels.combo.timeSeries.current_vs_prev(
      ...
      row.new('🛡 Rule Guard'),
        panels.combo.stat.a_bigger_value_is_a_problem(
          '❌ Failed 🛡 Rule Guard', queries.diff_over_time(queries.workflows.RuleGuard.average_failed_per_minute)
        ),
        panels.combo.timeSeries.current_vs_prev(
        ...
        panels.combo.stat.a_bigger_value_is_better(
          '✴️ Events 🛡 Rule Guard', queries.diff_over_time(queries.workflows.RuleGuard.average_events_per_minute)
        ),
        panels.combo.timeSeries.current_vs_prev(
        ...
        panels.combo.stat.a_bigger_value_is_a_problem(
          '🕒 Duration of 🛡 Rule Guard', queries.diff_over_time(queries.workflows.RuleGuard.average_duration_per_minute)
        ),
        panels.combo.timeSeries.current_vs_prev(
        ...
        panels.combo.stat.a_bigger_value_is_a_problem(
          '🕒 Duration of 🛡 Rule Guard', queries.diff_over_time(queries.workflows.RuleGuard.average_duration_per_hour)
        ),
        panels.combo.timeSeries.current_vs_prev(
        ...
        panels.combo.stat.a_bigger_value_is_a_problem(
          '🕒 Average Duration of one 🛡 Rule Guard', queries.diff_over_time(queries.workflows.RuleGuard.average_duration_per_event)
        ),
        panels.combo.timeSeries.current_vs_prev(
      ...
      row.new('🗓 On Schedule Full'),
        panels.combo.stat.a_bigger_value_is_a_problem(
        '❌ Failed 🗓 On Schedule Full', queries.diff_over_time(queries.workflows.OnScheduleFull.average_failed_per_minute)
        ),
        panels.combo.timeSeries.current_vs_prev(
        ...
        panels.combo.stat.a_bigger_value_is_better(
        '✴️ Events 🗓 On Schedule Full', queries.diff_over_time(queries.workflows.OnScheduleFull.average_events_per_minute)
        ),
        panels.combo.timeSeries.current_vs_prev(
        ...
        panels.combo.stat.a_bigger_value_is_a_problem(
        '🕒 Duration of 🗓 On Schedule Full', queries.diff_over_time(queries.workflows.OnScheduleFull.average_duration_per_minute)
        ),
        panels.combo.timeSeries.current_vs_prev(
        ...
        panels.combo.stat.a_bigger_value_is_a_problem(
        '🕒 Duration of 🗓 On Schedule Full', queries.diff_over_time(queries.workflows.OnScheduleFull.average_duration_per_hour)
        ),
        panels.combo.timeSeries.current_vs_prev(
        ...
        panels.combo.stat.a_bigger_value_is_a_problem(
        '🕒 Average Duration of one 🗓 On Schedule Full', queries.diff_over_time(queries.workflows.OnScheduleFull.average_duration_per_event)
        ),
        panels.combo.timeSeries.current_vs_prev(
