...
annotations
+ g.dashboard.new('Xodus storage: ↩️ Retried → 🟡 Consistent | 🟠 Non Consistent (' + std.extVar("EXT_SOURCE_TYPE") + ')')
+ g.dashboard.withDescription(|||
  ...
  🟡 Consistent | 🟠 Non Consistent
|||)
+ g.dashboard.withUid('xodus_storage_retried_' + std.extVar("EXT_SOURCE_TYPE"))
