...
annotations
+ g.dashboard.new('Xodus storage: 🚫️ Interrupted → ⌛️ Obsolete | ⏰ Overdue (' + std.extVar("EXT_SOURCE_TYPE") + ')')
+ g.dashboard.withDescription(|||
  ...
  ⌛️ Obsolete | ⏰ Overdue
|||)
+ g.dashboard.withUid('xodus_storage_interrupted_' + std.extVar("EXT_SOURCE_TYPE"))
...
//      ]),
    ...
    */
      ...
      panels.combo.stat.a_bigger_value_is_a_problem(
        '🚫️ Interrupted',
        queries.diff_over_time(cached_jobs.Interrupted.Interrupted_per_sec)
      ),
      ...
      panels.combo.stat.a_bigger_value_is_a_problem(
        '⌛️ Obsolete',
        queries.diff_over_time(cached_jobs.Interrupted.Obsolete_per_sec)
      ),
      panels.combo.timeSeries.current_vs_prev(
      ...
      panels.combo.stat.a_bigger_value_is_a_problem(
        '⏰ Overdue',
        queries.diff_over_time(cached_jobs.Interrupted.Overdue_per_sec)
      ),
      panels.combo.timeSeries.current_vs_prev(
      ...
      panels.combo.stat.a_bigger_value_is_a_problem(
        '⌛️ % Obsolete',
        queries.diff_over_time(cached_jobs.Interrupted.Obsolete_percent)
      ),
      panels.combo.timeSeries.current_vs_prev(
      ...
      panels.combo.stat.a_bigger_value_is_a_problem(
        '⏰ % Overdue',
        queries.diff_over_time(cached_jobs.Interrupted.Overdue_percent)
      ),
      panels.combo.timeSeries.current_vs_prev(
